...
urlpatterns = [
    ...
    path(
        ...
        views.product_offer_toggle,
        name="product_offer_toggle",
    ),
    path(
    ...
    path(
        ...
        views.category_offer_toggle,
        name="category_offer_toggle",
    ),
    path(
    ...
    path(
        "referral/<int:pk>/edit/", views.referral_offer_edit, name="referral_offer_edit"
    ),
    path(
        "referral/<int:pk>/toggle/",
        views.referral_offer_toggle,
        name="referral_offer_toggle",
    ),
    path(
        "referral/<int:pk>/delete/",
        views.referral_offer_delete,
        name="referral_offer_delete",
    ),
    path(
        "referral/<int:pk>/detail/",
